...
#'
#' @section Data types in htb files: The format of htb files
#' may seem to be a bit complicated,
...
#' 
#'
#' For example, your experiment may have simultaneous recording of
#' up to 20 isolated unit activities,
